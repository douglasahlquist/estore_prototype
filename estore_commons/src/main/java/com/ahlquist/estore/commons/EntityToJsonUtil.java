...
public class EntityToJsonUtil<T> {
	...
	public JSONObject toJson(T obj) {
		...
		// This is an ugly hack to get around not being able to pass in T obj and
		// calling T.getClass().getDeclaredFields()
	...
	// m.setThird("3rd");
	// m.setB((byte) 'b');
	// m.setDailyDouble(1.000);
	// m.setDoes(true);
	// m.setHesSuchACharacter('Q');
	// m.setShorty((short) 1);
	// m.setSinkingBoat((float) 1.0);
	//
	// HashMap<String, String> map = new HashMap<>();
	// map.put("4th", "some_value");
	// map.put("5th", "some_other");
	// map.put("6th", "yet_another");
	//
	// m.setMap(map);
	//
	// EntityToJsonUtil<MyEntity> e = new EntityToJsonUtil<MyEntity>();
	// System.out.println(e.toString(m));
	//
	// }
